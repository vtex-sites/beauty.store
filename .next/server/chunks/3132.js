...
exports.modules = {
  /***/ 8460: /***/ (
    ...
    /* harmony import */ var _wrap__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(6716)

    const sendAnalyticsEvent = (event) => {
      try {
        window.postMessage(
          (0, _wrap__WEBPACK_IMPORTED_MODULE_0__ /* .wrap */.re)(event),
          window.origin
        )
      } catch (e) {
  ...
  /***/ 6664: /***/ (
    ...
    /* harmony import */ var _utils_error__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(670)
    /* harmony import */ var _store_composed__WEBPACK_IMPORTED_MODULE_0__ =
    ...
    const createCartStore = (
      ...
      const store = (0,
      _store_composed__WEBPACK_IMPORTED_MODULE_0__ /* .createStore */.M)(
        defaultCart,
        namespace,
        onValidate
      )
      const addItem = (item) => {
        if (!item.id) {
          throw new _utils_error__WEBPACK_IMPORTED_MODULE_1__ /* .SDKError */.q(
            'You must provide an `id` for items'
          )
        }
        if (item.quantity < 0) {
          throw new _utils_error__WEBPACK_IMPORTED_MODULE_1__ /* .SDKError */.q(
            'Item quantity needs to be higher than zero'
          )
        }
  ...
  /***/ 3352: /***/ (
    ...
    const createSessionStore = (
      ...
      (0, _store_composed__WEBPACK_IMPORTED_MODULE_0__ /* .createStore */.M)(
        defaultSession,
        namespace,
        onValidate
      )
  ...
  /***/ 7244: /***/ (
    ...
    var external_idb_keyval_ = __webpack_require__(3430) // CONCATENATED MODULE: ./node_modules/@faststore/sdk/dist/store/persisted.js
    /**
    ...
    const compose = (pipeline, value) =>
      pipeline.reduce((acc, curr) => curr(acc), value)
    //# sourceMappingURL=compose.js.map
    // EXTERNAL MODULE: ./node_modules/@faststore/sdk/dist/store/base.js
    var base = __webpack_require__(4519) // CONCATENATED MODULE: ./node_modules/@faststore/sdk/dist/store/composed.js
    const identity = (x) => x
    ...
    const Button = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
      function Button(
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          'button',
          Object.assign(
            { ref: ref, 'data-fs-button': true, 'data-testid': testId },
            otherProps
          ),
          children
        )
  ...
  /***/ 1007: /***/ (
    ...
    const Icon = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
      function Button(
        { component, testId = 'store-icon', ...otherProps },
        ref
      ) {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          'span',
          Object.assign(
            { ref: ref, 'data-fs-icon': true, 'data-testid': testId },
            otherProps
          ),
          component
        )
  ...
  /***/ 8607: /***/ (
    ...
    const Input = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
      function Input({ variant, testId = 'store-input', ...otherProps }, ref) {
        const variants = {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          'input',
          Object.assign(
            { ref: ref, 'data-fs-input': true, 'data-testid': testId },
            variants,
            otherProps
          )
        )
  ...
  /***/ 953: /***/ (
    ...
    /* unused harmony export StorybookLink */
    /* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(6689)
    /* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__)
    ...
    const Link = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
      function Link(
        { as, children, testId = 'store-link', ...otherProps },
        ref
      ) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          Component,
          Object.assign(
            { ref: ref, 'data-fs-link': true, 'data-testid': testId },
            otherProps
          ),
          children
        )
     ...
     * instead.
     */
    const StorybookLink = /* unused pure expression or super */ null && Link
  ...
  /***/ 8164: /***/ (
    ...
    const List = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
      function List(
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
          Component,
          Object.assign({ ref: ref }, dataAttributes, otherProps)
        )
      }
    )
  ...
  /***/ 7995: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 7565: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 4019: /***/ (module, exports, __webpack_require__) => {
    'use strict'
    ...
    function getDomainLocale(path, locale, locales, domainLocales) {
      if (true) {
        const normalizeLocalePath =
          __webpack_require__(6340).normalizeLocalePath
  ...
  /***/ 8771: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 7942: /***/ (module, exports, __webpack_require__) => {
    'client'
    'use strict'
  ...
  /***/ 6340: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 4969: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 5678: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 9781: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 4989: /***/ (module, exports, __webpack_require__) => {
    'use strict'
  ...
  /***/ 2189: /***/ (module, exports, __webpack_require__) => {
    'client'
    'use strict'
